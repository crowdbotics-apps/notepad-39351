"""
Django settings for notepad_39351 project.
...
ROOT_URLCONF = 'notepad_39351.urls'
...
WSGI_APPLICATION = 'notepad_39351.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "notepad_39351 API",
    "DESCRIPTION": "API documentation for notepad_39351 App",
    "VERSION": "v1",
}
